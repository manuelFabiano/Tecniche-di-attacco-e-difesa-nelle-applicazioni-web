    ...
    <div class="container mx-auto py-8 text-white">
      ...
      <div class="mt-4 flex w-full ">
        <div class="mb-4 flex flex-grow">
          <div class="text-green-400 mt-1 w-1/12">Url > </div>
          <input type="text" id="searchInput" class="bg-gray-900 text-white w-full border border-gray-700 rounded-xl px-2 focus:outline-none mr-3">
        </div>
        <button onclick="search()" class="mr-2 bg-green-500 rounded-xl px-1 mb-4">Vai</button>
      ...
      <h1 class="text-4xl font-bold text-green-500 mt-4 mb-8"><? echo $row['title']; ?></h1>
      <p class="text-white"><? echo $row['body']; ?></p>
